...
const Privacy: React.FC = () => {
  return (
    <>
      <Breadcrumbs page_name="Privacy" title="Privacy Policy" />
      ...
      <div className="max-w-3xl mx-auto py-8 px-4 bg-white dark:bg-[#121212]">
        ...
        <ul className="list-disc pl-8 mb-4">
          ...
          <li>
            ...
            "We", "Us" or "Our" in this Agreement) refers to PeerLink.
          </li>
          <li>
          ...
          <li>
            <strong>Website:</strong> refers to PeerLink, accessible from{" "}
            <a
              target="_blank"
